...
<div class="container">
	<div class="row"><h1>Transaksi Karyawan Laundry</h1></div>
		<div class="panel-group row" id="accordin-laundry" role="talibast" aria-multiselectable="true">
							...
							<form method="POST">
								<div class="form-group">
							  		...
							  		<div class="input-group date" id="datetimepicker1">
					                    <input type='text' class="form-control" id="waktu-laundry" placeholder="Waktu Laundry"/>
